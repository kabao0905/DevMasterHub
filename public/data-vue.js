const DATA_VUE = {
  ...
  levels:[
    ...
    {id:'junior',name:'Junior',badge:'junior',desc:'Components & Composition API hiện đại',lessons:[
    ...
    {id:'senior',name:'Senior',badge:'senior',desc:'Phát triển Fullstack Vue với Nuxt.js & SSR',lessons:[
    ...
    {id:'master',name:'Master',badge:'master',desc:'Performance & Production',lessons:[
      {id:'advanced',title:'Mẫu thiết kế React nâng cao & Tối ưu hiệu năng',
