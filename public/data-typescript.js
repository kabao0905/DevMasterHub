...
levels:[
  {id:'newbie',name:'Newbie',badge:'newbie',desc:'TypeScript cơ bản',lessons:[
    {id:'intro',title:'TypeScript Fundamentals',
     theory:'<p><strong>TypeScript</strong> là ngôn ngữ mở rộng nâng cấp của JavaScript bổ sung hệ thống kiểu tĩnh (Static Typing). Điểm mạnh vượt trội của TypeScript là phát hiện và ngăn chặn lỗi ngay tại <strong>thời điểm biên dịch (Compile-time)</strong> thay vì đợi người dùng gặp lỗi lúc chạy (Runtime).</p><p>Các khái niệm cốt lõi gồm có: <em>Type Annotations, Interfaces, Type Aliases</em> và <em>Union Types</em>.</p>',
