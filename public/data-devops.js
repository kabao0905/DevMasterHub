const DATA_KUBERNETES = {
  ...
  levels:[
    {id:'newbie',name:'Newbie',badge:'newbie',desc:'Nền tảng Kubernetes & Kiến trúc Pods',lessons:[
      {id:'intro',title:'Kubernetes Overview & Architecture',
       theory:'<p><strong>Kubernetes (thường gọi tắt là K8s)</strong> là nền tảng mã nguồn mở hàng đầu thế giới dùng để điều phối, tự động hóa việc triển khai, mở rộng quy mô và quản lý các ứng dụng đóng gói trong Container (Docker).</p><p>Hệ thống K8s bao gồm 2 thành phần chính: <strong>Control Plane (Máy chủ điều khiển)</strong> chịu trách nhiệm quản lý toàn bộ trạng thái cụm (API Server, etcd, Scheduler, Controller Manager) và <strong>Worker Nodes (Máy chủ chạy ứng dụng)</strong> trực tiếp thực thi các Pods thông qua tiến trình kubelet và mạng kube-proxy.</p>',
       code:'# Pod — smallest deployable unit\napiVersion: v1\nkind: Pod\nmetadata:\n  name: my-app\n  labels:\n    app: web\nspec:\n  containers:\n  - name: web\n    image: nginx:alpine\n    ports:\n    - containerPort: 80\n    resources:\n      requests:\n        memory: "64Mi"\n        cpu: "250m"\n      limits:\n        memory: "128Mi"\n        cpu: "500m"\n\n# kubectl commands\n# kubectl apply -f pod.yaml\n# kubectl get pods\n# kubectl describe pod my-app\n# kubectl logs my-app\n# kubectl exec -it my-app -- /bin/sh',
       lang:'yaml',
       keyPoints:['Pod là đơn vị thực thi nhỏ nhất trong K8s, có thể chứa một hoặc nhiều Container','Control Plane đóng vai trò bộ não điều phối, trong khi Worker Nodes là nơi trực tiếp chạy ứng dụng','Luôn khai báo rõ ràng Resource Requests (tối thiểu) và Limits (tối đa) để tránh chiếm dụng tài nguyên','Công cụ dòng lệnh kubectl là phương thức chính để tương tác và quản trị toàn bộ cụm K8s'],
      ...
      {id:'deployments',title:'Deployments & Services',
       ...
       lang:'yaml',
       keyPoints:['Deployment duy trì trạng thái mong muốn (Desired State) và tự động thay thế Pod bị chết','Labels và Selectors là cơ chế liên kết mềm linh hoạt giữa Service và nhóm Pods tương ứng','ClusterIP dùng cho giao tiếp nội bộ giữa các microservice, LoadBalancer dùng để tiếp nhận lưu lượng từ Internet'],
    ...
    {id:'junior',name:'Junior',badge:'junior',desc:'ConfigMaps, Secrets, Volumes',lessons:[
      {id:'config',title:'ConfigMaps & Secrets',
       ...
       lang:'yaml',
       keyPoints:['ConfigMap lưu cấu hình công khai, Secret bảo vệ dữ liệu nhạy cảm có mã hóa Base64','envFrom cho phép nạp toàn bộ cặp key-value từ ConfigMap/Secret vào biến môi trường Pod','Có thể gắn ConfigMap/Secret thành các file tĩnh trên ổ đĩa thông qua cơ chế Volume Mounts'],
      ...
      {id:'scaling',title:'Auto-Scaling & Rolling Updates',
       ...
       lang:'yaml',
       keyPoints:['HPA tự động điều chỉnh số lượng bản sao Pod theo tải tài nguyên thực tế thời gian thực','Rolling Update với maxUnavailable: 0 đảm bảo ứng dụng luôn có sẵn phục vụ 100% thời gian','Lệnh kubectl rollout undo cho phép quay ngược phiên bản (Rollback) ngay lập tức nếu phiên bản mới bị lỗi'],
       exercise:'Setup HPA cho web app deployment'}
    ]},
    {id:'mid',name:'Mid-Level',badge:'mid',desc:'Mạng nội bộ Kubernetes, Dịch vụ Services & Ingress',lessons:[
      {id:'ingress',title:'Ingress & Networking',
       ...
       lang:'yaml',
       keyPoints:['Ingress quản lý định tuyến HTTP/HTTPS từ bên ngoài vào cụm theo tên miền và đường dẫn','Hỗ trợ tự động gắn chứng chỉ bảo mật TLS/SSL với Cert-Manager','NetworkPolicy giúp cô lập và bảo vệ cơ sở dữ liệu chỉ cho phép Backend được kết nối trực tiếp'],
...
const DATA_CICD = {
  ...
  levels:[
    {id:'newbie',name:'Newbie',badge:'newbie',desc:'Nền tảng CI/CD & Pipeline tự động hóa',lessons:[
    ...
    {id:'mid',name:'Mid-Level',badge:'mid',desc:'Xây dựng Pipeline CI/CD đa giai đoạn nâng cao',lessons:[
    ...
    {id:'senior',name:'Senior',badge:'senior',desc:'Bảo mật Pipeline, Quét lỗ hổng & Cổng chất lượng',lessons:[
    ...
    {id:'master',name:'Master',badge:'master',desc:'Mô hình GitOps với ArgoCD & Tự động triển khai',lessons:[
...
const DATA_NGINX = {
  ...
  levels:[
    {id:'newbie',name:'Newbie',badge:'newbie',desc:'Cơ bản về Nginx Web Server & Cấu hình Reverse Proxy',lessons:[
    ...
    {id:'mid',name:'Mid-Level',badge:'mid',desc:'Tối ưu hiệu năng máy chủ Nginx, Caching & Nén Gzip',lessons:[
      {id:'perf',title:'Tối ưu hiệu năng, Bộ nhớ đệm Caching & Tác vụ Celery',
    ...
    {id:'master',name:'Master',badge:'master',desc:'Kiến trúc máy chủ Production, Cân bằng tải Load Balancing & SSL/TLS',lessons:[
