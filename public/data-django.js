const DATA_DJANGO = {
  ...
  levels:[
    {id:'newbie',name:'Newbie',badge:'newbie',desc:'Nền tảng Django & Kiến trúc MVT',lessons:[
    ...
    {id:'junior',name:'Junior',badge:'junior',desc:'Forms, Auth & Admin',lessons:[
      ...
      {id:'auth',title:'Xác thực người dùng & Phân quyền bảo mật (Gates/Policies)',
    ...
    {id:'mid',name:'Mid-Level',badge:'mid',desc:'REST API & Class-Based Views',lessons:[
      {id:'drf',title:'Xây dựng RESTful API chuyên nghiệp với Django REST Framework (DRF)',
    ...
    {id:'senior',name:'Senior',badge:'senior',desc:'Tối ưu hiệu năng, Bộ nhớ đệm Caching & Tác vụ Celery',lessons:[
      {id:'perf',title:'Tối ưu hóa hiệu năng & Bộ nhớ Span/Memory',
    ...
    {id:'master',name:'Master',badge:'master',desc:'Triển khai ứng dụng lên Production & Mở rộng quy mô',lessons:[
