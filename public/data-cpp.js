...
levels:[
  ...
  {id:'newbie',name:'Newbie',badge:'newbie',desc:'Cú pháp cơ bản & nền tảng',lessons:[
    {id:'intro',title:'Hello World & Cài đặt',
     theory:'<p><strong>C++</strong> là ngôn ngữ lập trình hệ thống mạnh mẽ, cung cấp khả năng kiểm soát phần cứng trực tiếp và quản lý bộ nhớ chi tiết. C++ được sử dụng để xây dựng hệ điều hành (Windows, Linux), Game Engine AAA (Unreal Engine) và các hệ thống tài chính tốc độ cao.</p><p>Mọi chương trình C++ bắt đầu thực thi từ hàm <strong><code>main()</code></strong>. Thư viện <code>#include &lt;iostream&gt;</code> cho phép xuất dữ liệu ra màn hình với <code>std::cout</code> và nhận dữ liệu bàn phím với <code>std::cin</code>.</p>',
  ...
  {id:'junior',name:'Junior',badge:'junior',desc:'OOP & quản lý bộ nhớ',lessons:[
    {id:'oop-basics',title:'Lớp (Class) & Đối tượng (Object) cơ bản',
    ...
    {id:'pointers',title:'Con trỏ (Pointers) & Tham chiếu (References)',
  ...
  {id:'mid',name:'Mid-Level',badge:'mid',desc:'Templates, STL & Modern C++',lessons:[
    {id:'templates',title:'Templates & Lập trình Generic',
    ...
    {id:'smart-ptr',title:'Con trỏ thông minh (Smart Pointers) & Cơ chế RAII',
  ...
  {id:'senior',name:'Senior',badge:'senior',desc:'Đa luồng, Mẫu thiết kế & Tối ưu hiệu năng',lessons:[
    {id:'concurrency',title:'Lập trình đa luồng Multithreading & Concurrency',
    ...
    {id:'perf-optimization',title:'Tối ưu hóa bộ nhớ & Hiệu năng C++',
