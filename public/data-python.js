...
levels:[
  ...
  {id:'newbie',name:'Newbie',badge:'newbie',desc:'Syntax cơ bản Python',lessons:[
    {id:'intro',title:'Hello World & Cơ bản',
     theory:'<p><strong>Python</strong> là ngôn ngữ lập trình đa năng, trong sáng và phổ biến nhất thế giới trong các lĩnh vực Trí tuệ nhân tạo (AI/ML), Data Science, Xây dựng Backend Web và Tự động hóa hệ thống.</p><p>Khác biệt cốt lõi của Python là <strong>hoàn toàn không dùng dấu ngoặc nhọn {} hay dấu chấm phẩy ;</strong> để định nghĩa khối lệnh. Thay vào đó, Python áp dụng quy tắc <strong>Thụt lề bắt buộc (Indentation - 4 dấu cách)</strong> để phân cấp mã nguồn, giúp code luôn đồng nhất và dễ đọc.</p><p>Python là ngôn ngữ <em>Dynamic Typing</em>: Trình thông dịch tự động suy luận kiểu dữ liệu của biến tại thời điểm gán giá trị mà không cần khai báo kiểu tĩnh.</p>',
     code:'# Python cực kỳ đơn giản\nname = "DevMaster"\nage = 20\npi = 3.14159\nis_student = True\n\nprint(f"Hello, {name}!")\nprint(f"Age: {age}, Pi: {pi:.2f}")\n\n# Input\nuser_name = input("Your name: ")\nprint(f"Welcome {user_name}!")',
     lang:'python',
     keyPoints:['Python bắt buộc sử dụng thụt lề chuẩn (Indentation - 4 spaces) để phân chia khối lệnh thay vì dùng dấu ngoặc nhọn','Biến số trong Python được định kiểu động tự động khi gán giá trị','Chuỗi định dạng f-string (f"Hello {name}") là phương thức nối chuỗi chuẩn và tối ưu nhất trong Python hiện đại','Hàm input() nhận dữ liệu người dùng nhập từ bàn phím và luôn trả về kiểu chuỗi (str)'],
     exercise:'Viết chương trình nhập 2 số và in tổng, hiệu, tích, thương.'},

    {id:'conditions',title:'Điều kiện & Toán tử',
     theory:'<p>Cấu trúc điều kiện cho phép chương trình ra quyết định rẽ nhánh logic. Trong Python, ta sử dụng <code>if / elif / else</code> kết thúc bằng dấu hai chấm (<code>:</code>).</p><p>Toán tử logic trong Python sử dụng trực tiếp các từ tiếng Anh: <code>and</code> (và), <code>or</code> (hoặc), <code>not</code> (phủ định). Toán tử <code>in</code> giúp kiểm tra sự tồn tại của phần tử trong danh sách hay chuỗi một cách cực kỳ thanh lịch.</p>',
    ...
    {id:'loops',title:'Vòng lặp & Range',
     theory:'<p>Vòng lặp trong Python được thiết kế trực quan và tối ưu: <code>for ... in ...</code> dùng để duyệt qua các tập hợp dữ liệu (List, String, Dictionary hoặc dãy số sinh bởi <code>range()</code>).</p><p><strong>List Comprehension</strong> là kỹ thuật đặc trưng của Python giúp khởi tạo và biến đổi mảng dữ liệu chỉ trong một dòng code ngắn gọn và tối ưu tốc độ thực thi.</p>',
  ...
  {id:'junior',name:'Junior',badge:'junior',desc:'OOP, Modules & Xử lý ngoại lệ',lessons:[
    {id:'oop',title:'Lập trình Hướng đối tượng (OOP) trong Python',
    ...
    {id:'modules',title:'Modules, Packages & Đọc ghi File I/O',
    ...
    {id:'error-handling',title:'Xử lý lỗi & Gỡ lỗi (Try/Except & Debugging)',
  ...
  {id:'mid',name:'Mid-Level',badge:'mid',desc:'Decorators, Generators & Kỹ thuật nâng cao',lessons:[
    {id:'decorators',title:'Decorators & Closures trong Python',
    ...
    {id:'generators',title:'Generators & Iterators với yield',
    ...
    {id:'type-hints',title:'Type Hints & Dataclasses hiện đại',
  ...
  {id:'senior',name:'Senior',badge:'senior',desc:'Lập trình Bất đồng bộ, Kiểm thử & Web Frameworks',lessons:[
    {id:'async',title:'Lập trình Bất đồng bộ Async/Await & Concurrency',
    ...
    {id:'testing',title:'Kiểm thử ứng dụng với pytest',
    ...
    {id:'web-frameworks',title:'Xây dựng Web Backend với FastAPI',
  ...
  {id:'master',name:'Master',badge:'master',desc:'Metaclasses & Tối ưu hiệu năng CPython',lessons:[
    {id:'metaclasses',title:'Metaclasses & Thuộc tính Descriptors',
    ...
    {id:'performance',title:'Tối ưu hiệu năng & CPython Internals',
