const DATA_ANGULAR = {
  ...
  levels:[
    {id:'newbie',name:'Newbie',badge:'newbie',desc:'Nền tảng Angular & Data Binding',lessons:[
    ...
    {id:'junior',name:'Junior',badge:'junior',desc:'Services, Dependency Injection & Định tuyến Routing',lessons:[
    ...
    {id:'senior',name:'Senior',badge:'senior',desc:'Kiểm thử ứng dụng & Tối ưu hiệu năng Angular',lessons:[
      {id:'testing',title:'Kiểm thử ứng dụng Angular với Jasmine & Karma',
    ...
    {id:'master',name:'Master',badge:'master',desc:'Enterprise Patterns',lessons:[
      {id:'enterprise',title:'Kiến trúc phần mềm Angular quy mô lớn',
