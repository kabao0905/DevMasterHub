...
python: {
  ...
  levels:[
    ...
    {id:'master',name:'Master',badge:'master',desc:'Metaclasses, C Extensions & System Design',lessons:[
      {id:'metaclass',title:'Metaclasses & Thuộc tính Descriptors',
...
java: {
  ...
  levels:[
    ...
    {id:'junior',name:'Junior',badge:'junior',desc:'Collections, Streams & Exception Handling',lessons:[
      {id:'collections',title:'Khung dữ liệu Collections & Xử lý luồng Streams API',
...
react: {
  ...
  levels:[
    {id:'newbie',name:'Newbie',badge:'newbie',desc:'Cú pháp JSX, Thành phần Components & Props',lessons:[
